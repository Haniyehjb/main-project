...
void move_character(char mat[][128])
{
    while (1)
    {
        char ch;
        ch = _getch();
        if (ch == 'd' && char_j < 127 &&
            (mat[char_i][char_j + 1] == ' ' || mat[char_i][char_j + 1] == 8 || mat[char_i][char_j + 1] == 9 || mat[char_i][char_j + 1] == 3 ||
...
//        else if (ch == 's' && i < 13 &&
//                   (mat[i + 1][j] == ' ' || mat[i + 1][j] == 8 || mat[i + 1][j] == 9 || mat[i + 1][j] == 3 ||
//                    mat[i + 1][j] == '#' || mat[i + 1][j] == '*')) {
//            while (ch == 's' && i < 13 &&
//                   (mat[i + 1][j] == ' ' || mat[i + 1][j] == 8 || mat[i + 1][j] == 9 || mat[i + 1][j] == 3 ||
//                    mat[i + 1][j] == '#' || mat[i + 1][j] == '*')) {
...
//                ch = _getch();
//                if (ch == 'd' && j < 127 &&
//                    (mat[i][j + 1] == ' ' || mat[i][j + 1] == 8 || mat[i][j + 1] == 9 || mat[i][j + 1] == 3 ||
//                     mat[i][j + 1] == '#' || mat[i][j + 1] == '*')) {
//                    mat[i][j] = ' ';
//                    (j)++;
//                } else if (ch == 'a' && j > 0 &&
